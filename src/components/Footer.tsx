      ...
      <div className="wrap">
        <div className="foot-grid">
          <div className="foot-brand">
            ...
            <p>
              Making home ownership simple, smart &amp; stress-free. Smart mortgage solutions for
              residents, expats and investors across Dubai.
            </p>
          ...
          <div className="foot-col">
            <h5>Services</h5>
            <Link href="/services">Home Loan</Link><Link href="/services">Refinance</Link>
            <Link href="/services">Off-Plan Property</Link><Link href="/services">Buy-to-Let</Link>
            <Link href="/services">Equity Release</Link><Link href="/services">Commercial Property</Link>
          </div>
          <div className="foot-col">
            <h5>Company</h5>
            <Link href="/about">About Us</Link><Link href="/invest">Why Dubai</Link>
            <Link href="/process">How It Works</Link><Link href="/difficult-cases">Difficult Cases</Link>
            <Link href="/learn">Learn</Link><Link href="/calculator">Calculator</Link>
          </div>
          <div className="foot-col">
            <h5>Get in touch</h5>
        ...
        <div className="foot-bot">
          <span>© {new Date().getFullYear()} Xperts Mortgage. All rights reserved.</span>
          <span>Your dream home, our expertise.</span>
        </div>
      </div>
    </footer>
  );
